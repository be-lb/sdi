# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-10-13 13:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geometry_type', models.CharField(choices=[('Point', 'Point'), ('LineString', 'LineString'), ('Polygon', 'Polygon'), ('MultiPoint', 'MultiPoint'), ('MultiLineString', 'MultiLineString'), ('MultiPolygon', 'MultiPolygon')], max_length=16)),
                ...
                ('keywords', models.ManyToManyField(related_name='md_keyword', to='api.Keyword')),
            ],
        ),
        migrations.CreateModel(
            name='Organisation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('code', models.CharField(max_length=124)),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='topic_name', to='api.MessageRecord')),
                ('thesaurus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Thesaurus')),
            ],
        ),
        migrations.CreateModel(
            name='UserMap',
        ...
        migrations.AddField(
            ...
            name='metadata',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='layer_info_md', to='api.MetaData'),
        ),
        migrations.AddField(
            model_name='keyword',
            name='name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='keyword_name', to='api.MessageRecord'),
        ),
        migrations.AddField(
            model_name='keyword',
            name='thesaurus',
